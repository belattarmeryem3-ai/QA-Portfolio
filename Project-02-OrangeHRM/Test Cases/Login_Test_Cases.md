...
| TC_LOGIN_006 | Verify password field masks entered characters | User is on the OrangeHRM login page | 1. Click the password field.<br>2. Enter a password.<br>3. Observe the entered characters. | Password: admin123 | Entered password characters should be masked and should not be displayed as plain text. |
| TC_LOGIN_007 | Verify Login button is displayed and enabled | User is on the OrangeHRM login page | 1. Open the login page.<br>2. Observe the Login button. | N/A | The Login button is clearly visible and enabled. |
